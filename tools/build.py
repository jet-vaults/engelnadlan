...
def cta_section():
  ...
  <div class="wrap">
    <div>
      ...
      <p class="lead" style="margin-top:20px">השאירו פרטים וצוות המומחים שלנו יבחן את הבניין ויחזור אליכם עם תשובה מפורטת – ללא עלות וללא התחייבות.</p>
  ...
  <div class="wrap">
    ...
    <div class="facts">
      <ul>
        ...
        <li><b>ליווי בנקאי מלא</b>בנק הפועלים · כלל</li>
  ...
  <div class="wrap">
    <div class="split split--wide">
      ...
      <div class="rv" data-d="1">
        <p class="lead" style="max-width:none">אנגל נדל״ן היא חברת בוטיק משפחתית העוסקת בבנייה ובייזום מזה שנים, ומורכבת מאנשי מקצוע מהשורה הראשונה בתחומי הנדל״ן והבנייה. הניסיון המגוון של הצוות המוביל הוא היתרון שלנו – ושל הדיירים שלנו.</p>
    ...
    <div class="split split--wide">
      ...
      <div class="rv" data-d="1">
        <ul class="list-hair">
          ...
          <li><span class="n">03</span><div><b>הובלות</b><p>הובלת תכולת הדירות – הלוך וחזור – על חשבוננו.</p></div></li>
          ...
          <li><span class="n">05</span><div><b>מפרט גבוה, מקיף ויוקרתי</b><p>אנו מציעים לדיירים מפרט גבוה – ומסכמים אותו במלואו לפני תחילת הביצוע.</p></div></li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section section--dark grain">
  <div class="wrap">
    ...
    <ul class="list-hair rv">
      <li><span class="n">01</span><div><b>עיר אחת, התמחות אחת</b><p>אנחנו פועלים רק בתל אביב. אנחנו מכירים את הרחובות, את הוועדות ואת הזכויות – וזה מה שמאפשר לנו למקסם כל פרויקט.</p></div></li>
      ...
      <li><span class="n">04</span><div><b>סטנדרט של בוטיק</b><p>מפרט גבוה, מקיף ויוקרתי; בניינים קטנים ומדויקים; פגישת תכנון אישית עם אדריכל לכל דייר.</p></div></li>
    </ul>
  </div>
</section>
  ...
  <div class="wrap">
    <div class="split">
      ...
      <div class="rv" data-d="1">
        ...
        <h2 class="h-m">אנשי מקצוע מהשורה הראשונה, תחת קורת גג אחת</h2>
...
<section class="page-head">
  <div class="wrap">
    ...
    <h1 class="h-xl">נשמח לשמוע על הבניין שלכם.</h1>
...
<p>אנו עשויים להשתמש בעוגיות ובטכנולוגיות דומות כדי לשפר את חוויית המשתמש ולנתח את השימוש באתר. ניתן לנהל את העדפות העוגיות באמצעות הגדרות הדפדפן ולחסום אותן, אך הדבר עלול להשפיע על חוויית השימוש באתר.</p>
<h2>זכויות המשתמש</h2>
